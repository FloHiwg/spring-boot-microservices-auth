package com.heiwig.microserviceenv.authservice.config.mongodb.changelogs;

import com.github.mongobee.changeset.ChangeLog;
import com.github.mongobee.changeset.ChangeSet;
import com.heiwig.microserviceenv.authservice.domain.AuthClientDetails;
import com.heiwig.microserviceenv.authservice.domain.User;
import com.heiwig.microserviceenv.authservice.enums.Authorities;
...
public class InitialValuesChangeLog {
    ...
    @ChangeSet(order = "001", id = "insertBrowserClientDetails", author = "Florian Heiwig")
    public void insertBrowserClientDetails(MongoTemplate mongoTemplate) {
        System.out.println("Changelog 001");
    ...
    @ChangeSet(order = "002", id = "insertUserToTestAuthentication", author = "Florian Heiwig")
    public void insertUserToTestAuthentication(MongoTemplate mongoTemplate) {
        System.out.println("Changelog 002");
